<?php
	...
	class sv_block_preformatted extends init {
		public function init() {
			$this->set_module_title( __( 'Block: Preformatted', 'sv100' ) )
				...
				->set_block_handle('wp-block-preformatted')
				->get_root()
				->add_section( $this );
		}
		
		protected function load_settings(): sv_block_preformatted {
		...
		public function enqueue_scripts(): sv_block_preformatted {
			if(!$this->has_block_frontend('preformatted')){
				return $this;
			}
